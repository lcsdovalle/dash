...
class TurmaClassroom():
    ...
    def copiar_avisos_mural(self,id_turma, professor_email,logger):
...
# <HttpError 500 when requesting https://classroom.googleapis.com/v1/courses/111640585990/courseWork?alt=json returned "Internal error encountered."